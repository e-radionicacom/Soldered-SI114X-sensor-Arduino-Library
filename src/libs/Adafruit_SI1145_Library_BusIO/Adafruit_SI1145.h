...
#define SI1145_PARAM_ALS_RATE_MAX 0x08
#define SI1145_PARAM_ALS_ADCGAIN  0x00

#define SI1145_PARAM_IR_RATE_MAX 0x08
#define SI1145_PARAM_IR_ADCGAIN  0x00

#define SI1145_PARAM_ENABLE_INT      0x01
#define SI1145_PARAM_INT_ON_COMPLETE 0x00
#define SI1145_PARAM_ALS_ENABLE_INT  0x01
#define SI1145_PARAM_PS1_ENABLE_INT  0x04
#define SI1145_PARAM_PS2_ENABLE_INT  0x08

#define SI1145_PARAM_ALS_CLEAR_INT 0x01
#define SI1145_PARAM_PS1_CLEAR_INT 0x04
#define SI1145_PARAM_PS2_CLEAR_INT 0x08

#define SI1145_PARAM_PS_ADC_GAIN     0x00
#define SI1145_PARAM_PS_RATE_MAX     0x08
#define SI1145_PARAM_PS1_LED_CURRENT 0x03
#define SI1145_PARAM_PS2_LED_CURRENT 0x30
...
class Adafruit_SI1145
{
  public:
    ...
    ~Adafruit_SI1145();
    boolean begin(MEASUREMENT_MODE mode, uint8_t addr = SI1145_ADDR, TwoWire *pBus = &Wire);
    ...
    void setAutoMeasurementRate(uint16_t rate);
    ...
    void setUVMeasurementMode(MEASUREMENT_MODE mode);
